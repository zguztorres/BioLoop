        ...
        if not resultado_local.empty:
            ...
            with st.spinner(t["inferring"]):
                ...
                if respuesta_ia:
                    ...
                    # --- NUEVO: FLUJO DE SÍNTESIS DE ADN ---
                    uniprot_id = respuesta_ia.get("UniProt_ID")
                    chasis = respuesta_ia.get("Chassis", "Escherichia coli")
                    
                    # Verificamos que la IA nos haya dado un ID real
                    if uniprot_id and uniprot_id != "ID_Real" and uniprot_id != "Desconocido":
                        st.write("---")
                        ...
                        if secuencia_prot:
                            ...
                            st.error("❌ No se pudo descargar la secuencia desde los servidores de UniProt.")
                else:
                    st.error("❌ Error de comunicación con el Agente. Intenta de nuevo.")
